...
| [ADR 0032](docs/adr/0032-pi-tool-owned-wiki-runs.md) | Historical Pi tool ownership; superseded by durable Run control |
...
| `@okf-wiki/contract` | Shared Zod schemas + `okf.wiki-runs/v5` |
