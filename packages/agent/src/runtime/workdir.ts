...
export function runWorkdirPromptPaths(layout: RunWorkdirLayout): string {
  ...
  return [
    ...
    "  - inputs/         Projected sealed inputs (spec, evidence, defects, prior-wiki, prior-spec, operator-input, coverage, plan-scouts)",
    ...
    "  - inputs/plan-scouts/  Sealed durable plan.scout receipts (read before synthesizing Spec)",
