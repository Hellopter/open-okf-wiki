...
/** CoverageUnit plan coverage gate (multi-source + large single-repo surfaces). */
export {
  type AssertCoverageOptions,
  assertCoverage,
  cancelledUnitsFromSpec,
  type CoverageCancelledUnit,
  CoverageCancelledUnitSchema,
  ...
  CoverageResultRowSchema,
  CoverageResultSchema,
  type CoverageRowStatus,
  CoverageRowStatusSchema,
  type CoverageSourceInventory,
  CoverageSourceInventorySchema,
  type CoverageStopReason,
  CoverageStopReasonSchema,
  type CoverageSurfaceEntry,
  CoverageSurfaceEntrySchema,
  type CoverageUnit,
  type CoverageUnitKind,
  CoverageUnitKindSchema,
  CoverageUnitSchema,
  collectCoveredUnitIds,
  CoverageAssertError,
  ...
  type SpecCoverageBinding,
  type SpecCoverageCancelSource,
  sourceCoverageUnit,
  surfaceCoverageUnit,
  unitIdForSource,
  unitIdForSurface,
...
export {
  ...
  type WikiRunSpecRepositoryMap,
  WikiRunSpecRepositoryMapSchema,
  type WikiRunSpecSourceCoverageRow,
  WikiRunSpecSourceCoverageRowSchema,
  type WikiRunSpecSurfaceCoverageRow,
  WikiRunSpecSurfaceCoverageRowSchema,
  WikiRunSpecSchema,
  type WikiSpec,
  WikiSpecSchema,
} from "./run.js";
...
export {
  ...
  type WikiRunPlanReviewExecution,
