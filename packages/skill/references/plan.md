...
4. Maintain a living Spec under `analysis/` (e.g. `analysis/spec.json`) with domains, pages,
   questions, acceptance, and a concise changelog. Prefer the fewest Domains that still isolate
