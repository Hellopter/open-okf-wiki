...
export const zh: MessageTree = {
  ...
  specReview: {
    ...
    reviewLenses: "评审镜头",
    questions: "问题",
    domainPageCounts: "{domains} 个领域 · {pages} 个页面",
    openQuestionCount: "{count} 个待解问题",
    fanOutValue: "{domains}/{maxDomains} 领域 · {leaves}/{maxLeaves} 叶子",
    workUnitsTruncated: "显示前 {shown} / 共 {total} 个工作单元",
    loading: "正在加载已封存的计划…",
    refreshing: "正在刷新计划以匹配当前决策门…",
    loadError: "无法加载已封存的计划。请重试，或查看 Attempt 转录。",
    retry: "重试",
    coverage: "覆盖矩阵",
    coverageUnitId: "单元",
    coverageKind: "类型",
    coverageStatus: "状态",
    coveragePageCount: "页面数",
    coverageKindSource: "源码",
    coverageKindSurface: "表面",
    coverageStatusCovered: "已覆盖",
    coverageStatusGap: "缺口",
    coverageStatusCancelled: "已取消",
    coverageCounts: "{covered} 已覆盖 · {gap} 缺口 · {cancelled} 已取消（共 {total}）",
    coverageStopComplete: "完整",
    coverageStopGap: "存在覆盖缺口",
    coverageStopNotRequired: "无需覆盖",
    coverageNotRequired: "本计划无必需覆盖单元（轻路径）。",
    coverageGapBlocksApprove:
      "覆盖仍有缺口。请修订计划，为每个必需单元绑定或显式取消后再批准。",
  ...
  settings: {
    ...
    tabSkill: "Skill",
    tabDanger: "危险",
    generalCardDescription: "身份、会话预算、编排与角色模型。",
    sectionIdentity: "身份",
    sectionSession: "会话与超时",
    maxActiveRuns: "活跃 Run 数",
    maxConcurrentAttempts: "并发 Attempt 数",
    metaTitle: "工作区元数据",
    metaDescription: "此工作区的只读路径与标识。",
    name: "名称",
    ...
    contextTargetTokensHint:
      "Pi 自动上下文压缩的操作目标（接近该目标时触发压缩）。留空则在模型配置了最大上下文时使用其 85%。",
    ...
    planCoverageTitle: "计划覆盖 / 侦察",
    planCoverageHint:
      "多源运行默认使用自动混合：按源调研 + 主题侦察，并由覆盖清单门禁。除非需要固定拓扑，否则保持「自动」。",
    planScoutMode: "侦察模式",
    planScoutModeAuto: "自动",
    planScoutModeThematic: "主题",
    planScoutModeSource: "按源",
    planScoutModeHybrid: "混合",
    planScoutCount: "主题规划侦察数",
    planScoutCountHint:
      "仅主题侦察（入口 / 布局 / 测试 / 风险）。默认 0（轻路径）。多源调研使用下方「调研任务预算」，不受此计数限制。",
    planScoutConcurrency: "侦察并行度",
    planScoutConcurrencyHint: "同时运行的规划侦察数（默认等于侦察数）。",
    planSurveyTaskBudget: "调研任务预算",
    planSurveyTaskBudgetPlaceholder: "自动",
    planSurveyTaskBudgetHint:
      "按源调研任务的独立预算。留空则由宿主在「每 Run 最大源数」下推导。超出预算不会静默截断。",
    planRescoutMaxRounds: "再侦察轮数",
    planRescoutMaxRoundsHint: "覆盖缺口后的最大再侦察轮数（0 禁用）。默认 1。",
    requireSourceCoverage: "要求源覆盖",
    requireSurfaceCoverage: "要求表面覆盖",
    coverageRequirementAuto: "自动",
    coverageRequirementOn: "开启",
    coverageRequirementOff: "关闭",
    maxSourcesPerRun: "每 Run 最大源数",
    maxSourcesPerRunHint: "单次 Wiki Run 覆盖计划中的源上限。超限失败关闭（不静默截断）。",
    maxSurfacesRequired: "最大必需表面数",
    maxSurfacesRequiredHint: "由 inventory 推导的必需表面单元上限。超限失败关闭。",
  ...
  wiki: {
    ...
    loading: "加载已发布 Wiki…",
    emptyTitle: "尚未发布",
    emptyDescription: "发布路径下未找到 Markdown 页面。启动一次运行并批准发布以填充此视图。",
    goToRuns: "打开运行",
    pages: "页面",
    pagesAria: "Wiki 页面",
    loadingPage: "加载页面…",
  ...
  workbench: {
    ...
    deleteSessionDescription: "移除已保存的对话「{title}」。由它创建的 Wiki 运行将保留。",
    ...
    connection: "连接",
    agent: "Wiki 智能体",
    startConversation: "开始对话，或让智能体生成 Wiki。",
    promptIdle: "询问工作区问题，或使用 /wiki 生成 Wiki",
    promptBusy: "向正在运行的智能体追加方向",
    send: "发送消息",
    stop: "停止智能体",
    modelPicker: {
      ariaLabel: "会话模型",
      menuLabel: "切换模型",
      empty: "无可用模型",
      emptySettingsTitle: "在设置中添加模型",
      maxContext: "{n} 上下文",
      busyTitle: "请等待当前回合结束后再切换模型",
    },
    context: {
      meterAria: "上下文占用",
      window: "窗口",
      ...
      tokens: "令牌",
      phase: "阶段",
      compactHint: "输入 /compact 以释放上下文空间；忙碌时使用 /compact stop",
      insertCompact: "插入 /compact",
      phases: {
        normal: "正常",
        approaching_target: "接近目标",
        at_target: "已达目标",
        compacting: "正在压缩",
        unknown: "未知",
      },
      ...
      outTokens: "出 {n}",
      toolCalls: "工具 {n}",
      graphFillAria: "上下文占用 {percent}%",
      graphFillAriaUnknown: "上下文用量",
    },
    slash: {
      listLabel: "斜杠命令",
    },
    pauseRun: "暂停运行",
    pauseRunHint: "软暂停：之后可以继续此运行。",
    resumeRun: "继续",
    cancelRun: "取消运行",
    ...
    capacityFailureTitle: "上下文容量不足",
    capacityFailureHint: "此次尝试的模型上下文已用尽。请缩小任务后重试，或调整范围后重新运行。",
    noAutoRetryHint: "此类失败不会自动重试。请使用重试或重新运行，或修正配置后开始新运行。",
    cannotRetryReason: {
      runPublished: "已发布的运行无法重试；请开始新运行。",
      runCancelled: "已取消的运行无法重试。",
      nodeNotFound: "快照中找不到该节点。",
      nodeNotFailed: "仅失败节点可以重试。",
      nodeCancelled: "该节点已被取消。",
      nodeInvalidated: "该节点已失效；请在上游节点上重新运行。",
      attemptMissing: "该节点尚无尝试记录。",
      attemptNotRetryable: "最近一次尝试不是失败或中断状态。",
      freezeNotPinned: "输入尚未钉选，无法重试 freeze；请开始新运行。",
      hasConsumers: "下游已消费此输出；请使用重新运行，而不是重试。",
    },
    cannotRerunReason: {
      runPublished: "已发布的运行无法重新运行；请开始新运行。",
      runCancelled: "已取消的运行无法重新运行。",
      nodeNotFound: "快照中找不到该节点。",
      repairNode: "无法重新运行 repair 节点；请重试失败的修复，或通过评估调度新的修复。",
      planMaterialized: "执行拓扑已物化后不能重跑 plan；请新开一次运行。",
    },
    plan: "计划",
    execution: "执行过程",
    candidates: "候选结果",
    ...
    decisionFallback: "该运行正在等待操作者输入。",
    answerPlaceholder: "对此运行的回答",
    guidancePlaceholder: "可选说明",
    sendAnswer: "发送回答",
    acceptCandidate: "接受候选结果",
    repairAutomatically: "自动修复",
    approve: "批准",
    revise: "修订",
    decline: "拒绝",
    runCommandAccepted: "运行命令已接受",
    sessionBusy: "该会话已有正在执行的回合",
    noActiveTurn: "没有可调整方向的活跃回合",
    commandRejected: "会话命令未被接受",
    stopFailed: "无法停止会话",
    connectionStates: {
      connecting: "正在连接",
      live: "已连接",
    ...
    runStates: {
      ...
      pausing: "正在暂停",
      paused: "已暂停",
      waiting_for_operator: "等待操作输入",
      failed: "失败",
      publication_declined: "已拒绝发布",
      completed_unpublished: "等待发布",
      published: "已发布",
      cancelling: "正在取消",
      cancelled: "已取消",
    },
    ...
    autoRepair: "自动修复",
    semanticRepairRounds: "评审修复轮数",
    mechanicalRepairRounds: "校验修复轮数",
    reviewEnabled: "需要评审",
    recheck: "重新评估",
    parallelResearch: "并行调研",
    qualityLoop: "评审、修复与发布",
    stagePlan: "计划",
    stageResearch: "并行调研",
    stageSynthesis: "汇总生成",
    stageQuality: "质量闭环",
    stagePublication: "发布",
    planAdapt: "计划调整",
    independentResearch: "独立调研",
    backToOverview: "全部阶段",
    noStageNodes: "此阶段尚未创建节点。",
    fanOut: "并行展开",
    fanIn: "汇合",
    controlEdge: "门禁",
    domainLeafCount: "{count} 子任务",
    expandDomain: "展开子任务",
    collapseDomain: "收起子任务",
