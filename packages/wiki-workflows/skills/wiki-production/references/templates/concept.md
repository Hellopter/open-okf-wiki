...
3. Rules, invariants, or lifecycle
4. Valid states, transitions, or value constraints (when verified)
5. Where the concept is used
6. Links to implementing modules and flows
